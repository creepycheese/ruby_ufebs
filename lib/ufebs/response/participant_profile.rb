...
module Ufebs
  module Response
    class ParticipantProfile
      ...
      has_one :creation_reason, 'Ufebs::Response::ParticipantProfile::CreationReason', tag: 'CreationReason'
      has_one :bic_directory, 'Ufebs::Response::ParticipantProfile::BicDirectory', tag: 'BICDirectoryEntry'
      ...
      class BicDirectory
        ...
        has_one :participant_info, 'Ufebs::Response::ParticipantProfile::ParticipantInfo', tag: 'ParticipantInfo'
        has_many :accounts, 'Ufebs::Response::ParticipantProfile::Account', tag: 'Accounts'
        has_many :swift_bics, 'Ufebs::Response::ParticipantProfile::SwiftBics', tag: 'SWBICS'
      end
      ...
      class Account
        ...
        has_many :restricts, 'Ufebs::Response::ParticipantProfile::AccountRestrict', tag: 'AccRstrList'
      end
      ...
      class ParticipantInfo
        ...
        has_many :restricts, 'Ufebs::Response::ParticipantProfile::ParticipantRestrict', tag: 'RstrList'
      end
